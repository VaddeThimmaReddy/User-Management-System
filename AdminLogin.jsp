...
<center>
	...
	<h5>Please enter details in corresponding fields!!!</h5><br><br>
	<div class="mb-3">
	<label  for="exampleFormControlInput1" class="form-label">Enter Mobile Number : </label>
	<input type="tel" name="amob" id="tbamob" class="form" ><br>
	</div>
	<div class="mb-3">
	<label for="exampleFormControlInput1" class="form-label">Enter your Password : </label>
	<input type="password" name="apass" id="tbapass" class="form" ><br>
	</div>
	<input type="submit" name="sub" id="tbsub" value="Login" style="padding: 5px 40px; background-color: #4CAF50; color: white; border: none; border-radius: 5px; cursor: pointer;">
	</form>
</center>
</body>
</html>
