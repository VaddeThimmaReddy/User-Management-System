...
<style>
        ...
        table {
            ...
            width: 50%; /* Set the width of the table as needed */
        }

        th, td ,input {
            border: 2px solid black; /* Set the border thickness as needed */
            padding: 8px;
            text-align: left;
        }
    </style>
...
<ul>
	<form action="edit" method="post" >	
		...
		<h1>Welcome to the user details</h1>
		<br><br>
		
      <input type="submit" id="btnedit" name="edit" value="Edit Details" style="padding: 10px 20px; background-color: #4CAF50; color: white; border: none; border-radius: 5px; cursor: pointer;">
    <br>
		...
		<tr>
			<td>id : </td>
			<td><%=request.getAttribute("ui")%><br>
		</tr>
		<tr>
			<td>FULLNAME : </td>
			<td><%=request.getAttribute("un")%><br>
		</tr>
		<tr>
			<td>EMAIL : </td>
			<td><%=request.getAttribute("ue")%><br>
		</tr>
		<tr>
			<td>MOBILE : </td>
			<td><%=request.getAttribute("um")%><br>
		</tr>
		<tr>
			<td>CITY : </td>
			<td><%=request.getAttribute("uc")%><br>
		</tr>
		<tr>
			<td>USERNAME : </td>
			<td><%=request.getAttribute("uu")%><br>
		</tr>
		<tr>
			<td>PASSWORD : </td>
			<td><%=request.getAttribute("up")%><br>
		</tr>
		</table>
	</form>
	</ul>
